 ...
 */
	...
	// with the complete url to hybridauth library on your website
 	$GLOBAL_HYBRID_AUTH_URL_BASE         = "http://www.vcseason-asia.com/hybridauth/"; ////Digi3 modified
	...
	*/
	...
	(
		...
		"Google" => ARRAY ( 
				"enabled" 	=> TRUE,
				"keys"	 	=> ARRAY ( 
					"CONSUMER_KEY" 	  => "www.vcseason-asia.com",
					"CONSUMER_SECRET" => "1u2yfTKvbUr_kCBOrXlBzd2U", 
				),
		...
		"Facebook" => ARRAY ( 
				"enabled" 	=> TRUE,
				"keys"	 	=> ARRAY( 
					"APPLICATION_ID"  => "261857393842376", 
					"CONSUMER_SECRET" => "b675422287803e5e5aa7bd7b5aa9ad97", 
				),
		...
		"Twitter"   	=> ARRAY ( 
				"enabled" 	=> TRUE,
				"keys"	 	=> ARRAY( 
					"CONSUMER_KEY" 	  => "Whcz1UgrJuegPDXWy4XmBw",
					"CONSUMER_SECRET" => "hRFnkRvJ3YYQuBqLU0vc5j2Y1N9RgfMdixevmn9ZU", 
				),
